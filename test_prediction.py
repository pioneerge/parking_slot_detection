...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '-dir', type=str, default='/Users/danilginzburg/Projects/Project[S20]/3d-bounding-box-estimation-for-autonomous-driving/kitti_dataset', help='File to predict')
